--This file has been modified by Donald Robertson <donald@fsf.org> to work with the mesecon modpack. TNT can now be triggered with switches and powergenerators.
...
mesecon:register_on_signal_on(function(p, node)
	if node.name == "nuke:iron_tnt" then
		minetest.env:remove_node(p)
		spawn_tnt(p, "nuke:iron_tnt")
		nodeupdate(p)
